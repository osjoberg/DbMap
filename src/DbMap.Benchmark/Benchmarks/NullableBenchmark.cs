...
namespace DbMap.Benchmark.Benchmarks
{
    ...
    public class NullableBenchmark
    {
        ...
        private static readonly DbQuery NullQuery = new DbQuery("DbMap.Benchmark.Benchmarks.NullBenchmark.NullMethod");
        private static readonly DbQuery NotNullQuery = new DbQuery("DbMap.Benchmark.Benchmarks.NullBenchmark.NotNullMethod");
        private static readonly DbQuery EveryOtherNullQuery = new DbQuery("DbMap.Benchmark.Benchmarks.NullBenchmark.EveryOtherNullMethod");
